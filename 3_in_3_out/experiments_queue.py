...
comandos = [
    ...
    "python train_TrackNet3.py --load_weights=" + path_weights + " --save_weights=" + path_experimento2 + " --dataDir=" + path_data_train + " --valDir=" + path_data_val + " --epochs=80 --tol=4 --validation=1 --loss=4",
    "python train_TrackNet3.py --load_weights=" + path_weights + " --save_weights=" + path_experimento3 + " --dataDir=" + path_data_train + " --valDir=" + path_data_val + " --epochs=80 --tol=4 --validation=1 --loss=5",
]
